...
function solver(nx::Int,ny::Int,boundary=nothing)
    # Parameters 
    xmin = 0.0
    xmax = 1.0 
    ymin = 0.0 
...
_,defects,solution = solver(200,200)

# Visualize the  solutions
anim = @animate for i=1:size(solution,3)
    heatmap(solution[:,:,i],title="Timestep $(i)")
end 
gif(anim,"figures/wave_propagation.gif")